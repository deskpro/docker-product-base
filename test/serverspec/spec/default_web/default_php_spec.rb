...
describe "Check default PHP and PHP-FPM configurations" do
  ...
  describe file('/etc/php/php-fpm.d/www.conf') do
    it { should_not exist }
  end

  describe file('/etc/php/php-fpm.d/01-deskpro.conf') do
    it { should exist }
  end

  describe file('/etc/php/php-fpm.conf') do
    it { should exist }
  end
  ...
  describe file('/etc/php/conf.d/01-deskpro.ini') do
    it { should exist }
  end
